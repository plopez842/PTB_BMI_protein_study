...
full_corr = readRDS(file = "../output_RDS_objs/Fig5_PCN_int_objects/Fig5_mPTB_sampleCOV.RDS")
partial_corr = readRDS(file = "../output_RDS_objs/Fig5_PCN_int_objects/Fig5_mPTB_PCN.RDS")
