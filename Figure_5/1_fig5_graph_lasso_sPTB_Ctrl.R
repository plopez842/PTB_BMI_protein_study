...
#save comp matrix
filename_r2_act_perm = paste0(daterun,"_sPTB_r2_real_perm_lambda_min_",min,"_lambda_max_",max,".Rds")
...
#save user results 
filename_user_param = paste0(daterun,"sPTB_USER_PARAM_lambda_min_",min,"_lambda_max_",max,".RData")
