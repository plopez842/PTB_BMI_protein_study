...
# We also get supplemental figures 4a-d (only for mPTB)
...
filename_user_param = paste0(daterun,"_mPTB_USER_PARAM_lambda_min_",min,"_lambda_max_",max,".RData")
...
# R2 calcs of resutls (Sup Fig4d, mPTB)----
...
ggsave(r2_plots,
       ...
       filename = "Sup_Fig4D_R2_estimated_indirect_correlates_mPTB.pdf",
...
# save the real 
path ="../final_plots/sup_figure4"
pdf(file = "../final_plots/sup_figure4/SUP_FIG4C_mPTB_REAL_COV.pdf",width =3.5 , height = 3)
draw(real_cov_heatmap)
dev.off()

#save the PCN
pdf(file = "../final_plots/sup_figure4/SUP_FIG4C_mPTB_PCN.pdf",width =3.5 , height = 3)
draw(partial)
dev.off()

#save the estimated correlation matrix
pdf(file = "../final_plots/sup_figure4/SUP_FIG4C_mPTB_EST.pdf",width =3.5 , height = 3)
draw(estcov_mat_ht)
dev.off()
...
saveRDS(model_prec_mat,"../output_RDS_objs/Fig5_PCN_int_objects/Fig5_mPTB_precision_matrix.RDS")
